 ...
 * AgCpPackage entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.edwin.agentsys.model.AgCpPackage
 * @author MyEclipse Persistence Tools
 */
@Scope("prototype")
@Service("agCpPackageDAO")
public class AgCpPackageDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(AgCpPackageDAO.class);
	// property constants
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding AgCpPackage instance with property: " + propertyName
				+ ", value: " + value);
		try {
