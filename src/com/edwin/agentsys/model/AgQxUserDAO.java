...
/**
 	* A data access object (DAO) providing persistence and search support for AgQxUser entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.edwin.agentsys.model.AgQxUser
  * @author MyEclipse Persistence Tools 
 */
public class AgQxUserDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(AgQxUserDAO.class);
		//property constants
    ...
    public AgQxUser findById( java.lang.Integer id) {
        ...
        try {
            AgQxUser instance = (AgQxUser) getSession()
                    .get("com.edwin.agentsys.model.AgQxUser", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding AgQxUser instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public AgQxUser merge(AgQxUser detachedInstance) {
        ...
        try {
            AgQxUser result = (AgQxUser) getSession()
