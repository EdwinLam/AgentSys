 ...
 * AgQxRole entities. Transaction control of the save(), update() and delete()
...
public class AgQxRoleDAO extends BaseHibernateDAO {
	...
	public AgQxRole findById(java.lang.Integer id) {
		...
		try {
			AgQxRole instance = (AgQxRole) getSession().get(
					"com.edwin.agentsys.model.AgQxRole", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public AgQxRole merge(AgQxRole detachedInstance) {
		...
		try {
			AgQxRole result = (AgQxRole) getSession().merge(detachedInstance);
